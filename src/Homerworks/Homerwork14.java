...
public class Homerwork14 {
    public static void main(String[] args) {
        ...
        String word3=string5.split(" ")[3];
        String word4=string5.split(" ")[4];
        String word5=string5.split(" ")[5];
        ...
        // 5 задание
        String string6="Completely random text in English. In it, we just need to determine how many times the character 'a' occurs there. And we can use the split method and the length method.";
        String[] num=string6.split("");
        String S=string6.toLowerCase();
        int s=string6.length();

        System.out.println("Єлементов в массиве 5="+s);
        System.out.println("Кол-во єлементов в массиве="+num);
